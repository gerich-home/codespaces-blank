...
{			
	...
	{ 	
		public Luminance ColorAtPixel(double px, double py, int width, int height, double cam_z, double cam_size, IShape scene, IShape diffuse, IShape glossy, ILightSource lights, IEngine engine)
		{
